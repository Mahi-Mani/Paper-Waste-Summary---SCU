$(document).ready(function () {
  ...
  $("#donut-chart-text").html("<h4>How did each building sort the paper waste generated at their site? <a href='./building.html'>Click here <i class='fa-solid fa-arrow-right'></i></a></h4>")
